...
/**
 * A wrapper around the GeckoView to provide a basic GeckoView composable.
 *
 ...
 * @sample com.phucynwa.geckompose.sample.BasicWebViewSample
 */
@Composable
public fun GeckoView(
    state: WebViewState,
 ...
 * @param additionalHttpHeaders Optional, additional HTTP headers that are passed to [GeckoView.loadUrl].
 ...
 *
 * @param data The uri to load in the WebView
 * @sample com.phucynwa.geckompose.sample.WebViewSaveStateSample
 */
@Composable
